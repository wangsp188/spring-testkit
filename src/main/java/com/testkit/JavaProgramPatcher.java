...
//            我想验证这个类是要带有@SpringBootApplication注解的才可以
            ...
            if (SettingsStorageHelper.isEnableSideServer(project)) {
                // 相对路径到你的 JAR 包
                String relativeJarPath = "spring-testkit" + File.separator + "lib" + File.separator + "spring-testkit_side_server-0.0.1.jar";
            ...
            String linkJarPath = "spring-testkit" + File.separator + "lib" + File.separator + "spring-testkit_trace-0.0.1.jar";
//            增加ajar到
            ...
            if (traceConfig.isEnable()) {
                ...
                String agentPath = "spring-testkit" + File.separator + "lib" + File.separator + "spring-testkit_agent-0.0.1.jar";
